...
class _ProfileSetupPageState extends ConsumerState<ProfileSetupPage> {
  ...
  void initState() {
    ...
    _months = TextEditingController(
      text: draft.monthsExperience == 0
          ? ''
          : draft.monthsExperience.toString(),
    );
  }
        ...
        children: [
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const _SectionLabel(label: '동아리 역할'),
                  ...
                  const _SectionLabel(label: '주 사용 손'),
                  const SizedBox(height: 8),
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: FilledButton(onPressed: _submit, child: const Text('다음')),
            ),
          ),
        ],
      ),
